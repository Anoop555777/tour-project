      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'signin in successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51L7rHrSAwnnVpznUMyBaXbZ7tCuTDnpRD121ybxewT2oS2czTOo3xylFhMXHIgP2MZ5vK9XPLBhqgUB6GslFVlW100r3V2uNv3');
...
if (signinForm) signinForm.addEventListener('submit', function (e) {
  ...
  (0, _signin.signin)(name, email, password, confirmpassword);
});
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./signin":"signin.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
